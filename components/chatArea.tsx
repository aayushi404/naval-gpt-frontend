...
export default function ChatArea() {
    const [chat, setChat] = useState<{type:"llm"|"user", chat:string}[]>([{type:"llm", chat:"Lorem ipsum dolor sit, amet consectetur adipisicing elit. Iure temporibus excepturi, animi consectetur odio, iste eligendi dolores architecto voluptas quae, exercitationem voluptates deserunt recusandae tenetur debitis sed accusamus ipsa cum"}, {type:"user", chat: "Hiii! How are you? How is it going? Doing well?"}])
